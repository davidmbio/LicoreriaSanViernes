...
$temp->set('header', 'Listado de Clientes');
$temp->set('content','
       <div style="text-align: center;">            
    <section id="fluidGridSystem">
      <form class="form-search" action="javascript: Buscar_Cientes();" id="BClientes" name="BClientes">        
      ...
      <div id="Clientes"></div>
      <div id="clie_oculto" style="display: none;"></div>    
    </section>
</div>
