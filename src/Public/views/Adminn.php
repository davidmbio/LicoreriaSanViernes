...
$temp->set('title','Logeo a Licoreria-Admin ');
...
<form action="javascript: Logear();" method="post" id="FLogin" class="modal fade in" >  
    <div class="alert alert-info"><h4>Acceso a Sanviernes - Admin</h4></div>
...
<div class="row" style="padding-bottom: 5px;">
    ...
    <div class="modal-footer">
        ...
        <input name="cancelar" type="button" id="cancelar" class="btn" value="Cancelar" onclick="Cancelado();" />
    </div>
</form>  
');
...
<script language="javascript" type="text/javascript">
	function Logear(){
        ...
        function Accedido() {
            location.href='../../Admin/View/index.php';
        } 
        function Cancelado() {
