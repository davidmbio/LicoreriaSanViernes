...
CREATE TABLE `tblComentarios` (
  ...
  CONSTRAINT `fk_tblComentarios_1` FOREIGN KEY (`IdCliente`) REFERENCES `tblCliente` (`IdCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tblComentarios_2` FOREIGN KEY (`IdProducto`) REFERENCES `tblProductos` (`IdProducto`) ON DELETE NO ACTION ON UPDATE NO ACTION
